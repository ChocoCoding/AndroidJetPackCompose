...
@Composable
fun _4Screen(navController: NavController){
    Scaffold (topBar = {
        TopAppBar() {
            ...
            Text(text = "Ventana Column 2")
        }
    }){
        _4BodyContent(navController)
    }
}

@Composable
fun _4BodyContent(navController: NavController){
    Column(
...
fun BoxPreview(){
    ...
    {
        TextStyle("MRN",)
        TextStyle("mrnovoa",modifier=Modifier.align(Alignment.BottomEnd))
    }
}
